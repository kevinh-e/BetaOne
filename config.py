...
# --- MCTS ---
NUM_SIMULATIONS = 350  # Number of MCTS simulations per move
...
WIDEN_COEFF = 1.5
MCTS_BATCH_SIZE = 128  # the higher the better, there seems to be no plateau
